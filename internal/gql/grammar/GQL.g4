...
// SPDX-FileCopyrightText: 2025 Michael Burbidge and Contributors
// SPDX-FileContributor: 2025 Marc Trölitzsch
//
// --------------------------- MODIFICATIONS ----------------------------------
// This file was modified from the original upstream version.
//   * All changes are surrounded by comments containing the string "MODIFIED".
//   * Original upstream version: commit 8ab19da on 2025-03-01.
// ----------------------------------------------------------------------------
...
elementTypeSpecification
    : (nodeTypeSpecification | edgeTypeSpecification) (compositePrimaryKey | compositeUniqueConstraint)?
    ;
compositePrimaryKey
    : primaryKey LEFT_PAREN fieldNameList RIGHT_PAREN
    ;

compositeUniqueConstraint
    : UNIQUE LEFT_PAREN fieldNameList RIGHT_PAREN
    ;
...
arcTypePointingRight
    : simpleArcTypePointingRight
    | arcWithCardinalityPointingRight
    ;
...
arcWithCardinalityPointingRight
    : MINUS_SIGN cardinality MINUS_LEFT_BRACKET
      edgeTypeFiller RIGHT_BRACKET_MINUS cardinality RIGHT_ARROW
    ;

arcTypePointingLeft
    : simpleArcTypePointingLeft
    | arcWithCardinalityPointingLeft
    ;
...
arcWithCardinalityPointingLeft
    : LEFT_ARROW cardinality MINUS_LEFT_BRACKET edgeTypeFiller RIGHT_BRACKET_MINUS cardinality MINUS_SIGN
    ;

arcTypeUndirected
    : simpleArcTypeUndirected
    | arcWithCardinalityUndirected
    ;
...
arcWithCardinalityUndirected
    : TILDE cardinality TILDE_LEFT_BRACKET edgeTypeFiller RIGHT_BRACKET_TILDE cardinality TILDE
    ;

cardinality
    : LEFT_PAREN cardinalityFiller RIGHT_PAREN
    ;

cardinalityFiller
    : cardinalityLowerBound COMMA cardinalityUpperBound
    ;
...
propertyValueType
    : valueType (UNIQUE | primaryKey | checkConstraint)*
    ;
// END MODIFIED
